				...
				<div>
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation" class="active">
							<a href="#home" aria-controls="home" role="tab" data-toggle="tab">News Feed <samp>${count_Article }</samp></a>
						</li>
						<li role="presentation">
							<a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Reply <samp>${count_Comment }</samp></a>
						</li>
						<li role="presentation">
							<a href="#follow" aria-controls="follow" role="tab" data-toggle="tab">Following</a>
						</li>
						<li role="presentation">
							<a href="#favorite" aria-controls="favorite" role="tab" data-toggle="tab">Favorite <samp>${count_favorite }</samp></a>
						</li>
					</ul>
					...
					<div class="tab-content">
								...
								<div class="row">
									...
									<div class="col-xs-3 col-md-1">
										<form action="${APP_PATH }/articleController/deleteArticle">
											...
											<button type="submit" class="btn btn-danger btn-sm" onclick="return f_del();">Delete</button>
										</form>
									</div>
								</div>
									...
									<div class="row" style="position: relative; margin-top: -10px;">
										...
										<div class="col-xs-3 col-md-1">
											<form action="${APP_PATH }/commentController/deleteComment">
												...
												<button type="submit" class="btn btn-danger btn-sm" onclick="return p_del();">Delete</button>
											</form>
										</div>
									</div>
								</c:forEach>
						...
						<div role="tabpanel" class="tab-pane" id="profile">
							...
							<c:forEach var="myComment_reply" items="${myComments_reply }">
								...
								<c:if test="${map_reply[myArticle_Fid].status==1 }">
									<div class="row">
										...
										<div class="col-xs-12 col-md-12">
											<c:if test="${map_reply[myArticle_Fid].photo!=\"photo\" }">
												<a href="${APP_PATH }/static/upload/article/${map_reply[myArticle_Fid].photo }" target="_blank">
									...
									<c:set var="myListComment_Fid" value="myListComment_reply_${myComment_reply.fid }"></c:set>
						...
						<div role="tabpanel" class="tab-pane" id="follow">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation" class="active">
									<a href="#icare" aria-controls="icare" role="tab" data-toggle="tab">Following <samp>${icare_count }</samp></a>
								</li>
								<li role="presentation">
									<a href="#careme" aria-controls="careme" role="tab" data-toggle="tab">Follower <samp>${careme_count }</samp></a>
								</li>
							</ul>
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane active" id="icare">
									<c:if test="${myListFollows==\"[]\" }">
										...
										<div class="text-center">
											...
											<p style="color: #999999">Maybe you haven’t met someone you’re interested in yet...</p>
										</div>
										<br><br><br><br>
									</c:if>
									<c:if test="${myListFollows!=\"[]\" }">
										...
										<c:forEach var="myListFollow" items="${myListFollows }">
											<div class="row">
												...
												<div class="col-xs-5 col-md-8">
													<a class="a_b" href="${APP_PATH}/userController/getOthers?userid=${myListFollow.userid }">
														<!-- Aurhor name -->
												...
												<div class="col-xs-4 col-md-2 follow">
													<form action="${APP_PATH }/followController/deleteFollowMyself">
														<a href="#">
															...
															<input type="hidden" name="beuserid" value="${myListFollow.userid }">
															<button type="submit" class="btn button2 btn-sm" style="width:80px;">Unfollow</button>
															<button type="submit" class="btn" style="width:80px;">Followed</button>
														</a>
													</form>
												</div>
											</div>
										...
										<c:forEach var="myListFollow_be" items="${myListFollows_be }">
											<div class="row">
												...
												<div class="col-xs-9 col-md-8">
													<a class="a_b" href="${APP_PATH}/userController/getOthers?userid=${myListFollow_be.userid }">
														<!-- Author name -->
													...
													<br>
													<samp>Follower: <b class="text-success">${myListFollow_be.followcount }</b></samp>
												</div>
											</div>
											<hr>
										</c:forEach>
						...
						<div role="tabpanel" class="tab-pane" id="favorite">
							...
							<c:if test="${myListFavorites!=\"[]\" }">
								...
								<c:forEach var="myListFavorite" items="${myListFavorites }">
									<div class="row">
										<div class="col-xs-2 col-md-1">
											<form action="${APP_PATH }/favoriteController/deleteFavoriteByUseridAndFid" method="post">
												<input type="hidden" name="userid" value="${userid }">
												<input type="hidden" name="fid" value="${myListFavorite.fid }">
												<button type="submit" style="border: none;background-color: #ffffff;">
													<samp title="Cancel Favorite" class="glyphicon glyphicon-heart favorite_end"></samp>
												</button>
											</form>
										</div>
