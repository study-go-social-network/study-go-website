        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content col-md-12">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title text-center" id="exampleModalLabel">Edit</h3>
                </div>
                <div class="modal-body">
                    <form action="${APP_PATH }/userController/updateUser" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
	                    	...
	                    	<c:if test="${myListUser.sex==\"Female\" }">
	                            <div class="col-sm-10">
	                                <label class="radio-inline">
	                    	...
	                    	<c:if test="${myListUser.sex!=\"Female\" && myListUser.sex!=\"Male\"}">
	                            <div class="col-sm-10">
	                                <label class="radio-inline">
	                                    <input type="radio" name="sex" id="sex" value="Male"> Male
	                                </label>
                        ...
                        <div class="form-group">
                            <label for="family" class="col-sm-2 control-label">Home Address</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="family" name="family" value="${myListUser.family }">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="intro" class="col-sm-2 control-label">Brief Intro</label>
                            <div class="col-sm-10">
