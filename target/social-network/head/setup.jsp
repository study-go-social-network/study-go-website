...
<body>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content col-md-12">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title text-center" id="exampleModalLabel">Profile Setting</h3>
                </div>
                        	...
                        	<div class="row">
	                            ...
	                            <div class="col-sm-10">
	                                <p class="form-control-static">${username }
	                                	<a href="#" id="setup_username_on" class="text-success"><b>Update</b></a>
	                                </p>
	                            </div>
							</div>
                        	...
                        	<div class="row">
	                            ...
	                            <div class="col-sm-10">
	                            	<p class="form-control-static">*********
	                            		<a href="#" id="setup_password_on" class="text-success"><b>Update</b></a>
	                            	</p>
	                            </div>
	                        </div>
                        	...
                        	<div class="row">
	                            ...
	                            <div class="col-sm-10">
	                                <p class="form-control-static">${email }
	                                	<a href="#" id="setup_email_on" class="text-success"><b>Update</b></a>
	                                </p>
	                            </div>
	                        </div>
	...
	$("#setup_username_on").click(function() {
		$("#setup_username").show();
		$("#setup_username_on").hide(); // hide
	});
	$("#setup_username_off").click(function() {
		$("#setup_username_on").show();
		$("#setup_username").hide();// hide
		/* Assign a value to the specified input box */
	...
	$("#setup_email_on").click(function() {
		$("#setup_email").show();
		$("#setup_email_on").hide();// hide
	});
	$("#setup_email_off").click(function() {
		$("#setup_email_on").show();
		$("#setup_email").hide();// hide
		/* Assign a value to the specified input box */
